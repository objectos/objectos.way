...
public final class ProtectedModifier extends AbstractModifierImpl
    implements
    ClassModifier,
    ConstructorModifier,
    EnumModifier,
  ...
  static final ProtectedModifier INSTANCE = new ProtectedModifier();

  private ProtectedModifier() {
    super("protected");
  }
