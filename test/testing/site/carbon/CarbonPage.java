...
abstract class CarbonPage extends Carbon.Template {
  ...
  private static final Html.Id menuButton = Html.Id.of("menu-button");

  private static final Html.Id closeButton = Html.Id.of("close-button");

  private static final Html.Id sideNav = Html.Id.of("side-nav");

  private static final Html.Id sideNavBody = Html.Id.of("side-nav-body");
