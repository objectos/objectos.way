...
public class HttpRequestMatcher1MethodNotAllowedTest {
  ...
  public void match(HttpMethod method) {
    ...
    final HttpRequestMatcher1MethodNotAllowed matcher;
    matcher = new HttpRequestMatcher1MethodNotAllowed(allowed);
