...
public class HttpHandler0MethodTest {
  ...
  public void handle(HttpMethod method) {
    ...
    http = HttpExchange.create(opts -> opts.method(method));

    final HttpHandler0Method handler;
    handler = new HttpHandler0Method(method, ok);
