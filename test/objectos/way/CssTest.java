...
public class CssTest {
  ...
  @Test
  public void escapeAsCodePoint() {
    escapeAsCodePoint(',', "\\2c ");
  }

  private void escapeAsCodePoint(char c, String expected) {
    final StringBuilder out;
    out = new StringBuilder();

    Css.escapeAsCodePoint(out, c);
  ...
  private void serializeIdentifier(String source, String expected) {
    ...
    Css.serializeIdentifier(out, source);
