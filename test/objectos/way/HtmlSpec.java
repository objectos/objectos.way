...
final class HtmlSpec {
  ...
  static List<AttributeSpec> attributes0() {
    return List.of(
        ...
        new AttributeSpec("ARIA_CURRENT", "ariaCurrent", "aria-current", false),
        new AttributeSpec("ARIA_DISABLED", "ariaDisabled", "aria-disabled", false),
        new AttributeSpec("ARIA_HIDDEN", "ariaHidden", "aria-hidden", false),
        new AttributeSpec("ARIA_INVALID", "ariaInvalid", "aria-invalid", false),
        new AttributeSpec("ARIA_LABEL", "ariaLabel", "aria-label", false),
        new AttributeSpec("ARIA_LABELLED_BY", "ariaLabelledBy", "aria-labelledby", false),
        new AttributeSpec("ARIA_MODAL", "ariaModal", "aria-modal", false),
        new AttributeSpec("ARIA_READONLY", "ariaReadonly", "aria-readonly", false),
        new AttributeSpec("ARIA_PLACEHOLDER", "ariaPlaceholder", "aria-placeholder", false),
        new AttributeSpec("ARIA_REQUIRED", "ariaRequired", "aria-required", false),
        new AttributeSpec("ARIA_SELECTED", "ariaSelected", "aria-selected", false),
        ...
        new AttributeSpec("ONLOAD", "onload", "onload", false),
