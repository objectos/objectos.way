...
public class UtilGrowableSequencedMapTest {

  private UtilGrowableSequencedMap<Thing, String> it;

  @BeforeClass
  public void _beforeClass() {
    it = new UtilGrowableSequencedMap<>();
  }
  ...
  public void toStringTest() {
    assertEquals(it.toString(), "UtilGrowableSequencedMap []");
