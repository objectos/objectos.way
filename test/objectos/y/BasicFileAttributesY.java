...
public final class BasicFileAttributesY {
  ...
  public static BasicFileAttributes create() {
    final BasicFileAttributesY y;
    y = new BasicFileAttributesY();

    return y.build();
  }

  public static BasicFileAttributes create(Consumer<? super BasicFileAttributesY> opts) {
    final BasicFileAttributesY y;
    y = new BasicFileAttributesY();
