...
import objectos.way.dev.Script014;
import org.testng.annotations.Listeners;
import org.testng.annotations.Test;

@Listeners(Y.class)
public class Script014Test {

  @Test
  public void action() {
    assertEquals(
        Script014.ACTION.toString(),

        """
        ["X1",["EI",["JS","subject"]],["MO",["X1",["EI",["JS","src"]],["PR","Element","innerHTML"],["TY","string"]]]]"""
    );
  }
  ...
  public void live() {
    try (var page = Y.page()) {
      ...
      assertThat(subjectHd).hasText("SRC");
      assertThat(subjectFixed).hasText("Fixed");
