...
public class UtilUnmodifiableListTest {

  private UtilUnmodifiableList<Thing> ul0;

  private UtilUnmodifiableList<Thing> ul1;

  private UtilUnmodifiableList<Thing> ul2;

  private UtilUnmodifiableList<Thing> ul3;

  private UtilUnmodifiableList<Thing> ulX;
  ...
  public void _beforeClass() {
    ul0 = UtilUnmodifiableList.of();
    jdk0 = List.of();

    var t1 = Thing.next();

    ul1 = UtilUnmodifiableList.of(t1);
    jdk1 = List.of(t1);

    var t2 = Thing.next();

    ul2 = UtilUnmodifiableList.of(t1, t2);
    jdk2 = List.of(t1, t2);

    var t3 = Thing.next();

    ul3 = UtilUnmodifiableList.of(t1, t2, t3);
    jdk3 = List.of(t1, t2, t3);

    Thing[] many = Thing.nextArray();

    ulX = UtilUnmodifiableList.copyOf(many);
    jdkX = List.of(many);
  }
  ...
  public void copyOf() {
    ...
    Consumer<UtilUnmodifiableList<Thing>> tester = l -> {
    ...
    try {
      ...
      UtilUnmodifiableList.copyOf(nullIterable);
    ...
    var ulIterable = UtilUnmodifiableList.copyOf(iterable);
    ...
    tester.accept(UtilUnmodifiableList.copyOf(growableList));
    ...
    tester.accept(UtilUnmodifiableList.copyOf(arrayList));
    ...
    try {
      UtilUnmodifiableList.copyOf(arrayListWithNull);
    ...
    tester.accept(UtilUnmodifiableList.copyOf(collection));

    // Collection with null
    var collectionWithNull = new LinkedHashSet<>(arrayListWithNull);

    try {
      UtilUnmodifiableList.copyOf(collectionWithNull);
  ...
  */
  ...
  public void lastIndexOf() {
    ...
    var it = UtilUnmodifiableList.copyOf(arrayList);
  ...
  private void testAll(BiConsumer<UtilUnmodifiableList<Thing>, List<Thing>> tester) {
