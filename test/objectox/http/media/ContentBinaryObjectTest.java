...
public class ContentBinaryObjectTest {

  @Test
  public void toTestableText01() {
    record Data(String value) implements BinaryObject {
      @Override
    ...
    final Data data;
    data = new Data("Not Testable");

    final ContentBinaryObject subject;
    subject = new ContentBinaryObject(MediaType.TEXT_PLAIN, data);

    assertEquals(subject.toTestableText(), """
    text/plain; charset=utf-8
    Data[value=Not Testable]\
    """);
  }
