...
public final class HttpServerException extends IOException implements ServerTaskMessage {
  ...
  public HttpServerException(Kind kind) {
    this.kind = kind;
  }

  public HttpServerException(Throwable cause, Kind kind) {
    super(cause);
