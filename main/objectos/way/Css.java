...
public final class Css {
  ...
  static Map<String, CssEngine.Variant> systemVariants() {
    return Map.ofEntries(
        Map.entry("dark", CssEngine.simple("@media (prefers-color-scheme: dark)")),

        Map.entry("active", CssEngine.simple("&:active")),
        Map.entry("checked", CssEngine.simple("&:checked")),
        Map.entry("disabled", CssEngine.simple("&:disabled")),
        Map.entry("first-child", CssEngine.simple("&:first-child")),
        Map.entry("focus", CssEngine.simple("&:focus")),
        Map.entry("focus-visible", CssEngine.simple("&:focus-visible")),
        Map.entry("hover", CssEngine.simple("&:hover")),
        Map.entry("last-child", CssEngine.simple("&:last-child")),
        Map.entry("visited", CssEngine.simple("&:visited")),

        Map.entry("after", CssEngine.simple("&::after")),
        Map.entry("backdrop", CssEngine.simple("&::backdrop")),
        Map.entry("before", CssEngine.simple("&::before")),
        Map.entry("first-letter", CssEngine.simple("&::first-letter")),
        Map.entry("first-line", CssEngine.simple("&::first-line")),

        Map.entry("*", CssEngine.simple(":is(& > *)")),
        Map.entry("**", CssEngine.simple(":is(& *)"))
    );
  }
