...
class DomFormatter {
  ...
  private static final Set<String> PHRASING = Set.of(
      ...
      HtmlElementName.ABBR.lowerCase,
      HtmlElementName.B.lowerCase,
      HtmlElementName.BR.lowerCase,
      HtmlElementName.BUTTON.lowerCase,
      HtmlElementName.CODE.lowerCase,
      HtmlElementName.EM.lowerCase,
      HtmlElementName.IMG.lowerCase,
      HtmlElementName.INPUT.lowerCase,
      HtmlElementName.KBD.lowerCase,
      HtmlElementName.LABEL.lowerCase,
      HtmlElementName.PROGRESS.lowerCase,
      HtmlElementName.SAMP.lowerCase,
      HtmlElementName.SELECT.lowerCase,
      HtmlElementName.SMALL.lowerCase,
      HtmlElementName.SPAN.lowerCase,
      HtmlElementName.STRONG.lowerCase,
      HtmlElementName.SUB.lowerCase,
      HtmlElementName.SUP.lowerCase,
      HtmlElementName.SVG.lowerCase,
      HtmlElementName.TEMPLATE.lowerCase,
      HtmlElementName.TEXTAREA.lowerCase
  );
