...
public final class Html {
  ...
  /**
   * Wraps a checked exception thrown by an invoked fragment of an HTML
   * template.
   */
  public static final class FragmentException extends RuntimeException {

    private static final long serialVersionUID = 4587764358138247203L;

    FragmentException(Exception cause) {
      super(cause);
    }
