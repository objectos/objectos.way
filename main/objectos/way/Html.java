...
import objectos.http.ContentSender;
...
public final class Html {
  ...
  /// HTML document.
  @FunctionalInterface
  public interface Component extends Content, Media.Text, OutputStreamConsumer, Testable {
    ...
    @Override
    default void acceptOutputStream(OutputStream out) throws IOException {
