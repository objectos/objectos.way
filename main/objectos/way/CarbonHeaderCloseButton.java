...
final class CarbonHeaderCloseButton extends CarbonComponent implements HeaderCloseButton {
  ...
  public CarbonHeaderCloseButton(Html.Template tmpl) {
    super(tmpl);
  ...
  @Override
  public final HeaderCloseButton ariaLabel(String value) {
    ariaLabel = Check.notNull(value, "value == null");
    return this;
  }

  @Override
  public final HeaderCloseButton dataOnClick(Script.Action value) {
    Script.Action a;
  ...
  @Override
  public final HeaderCloseButton title(String value) {
