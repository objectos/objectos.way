...
public final class Hover {
  ...
  public enum BackgroundColor implements StyleClass {
    ...
    public final String toString() {
      return "." + className + ":hover" + " { background-color: " + value + " }";
    }
  ...
  public enum BorderColor implements StyleClass {
    ...
    @Override
    public final String toString() {
      return "." + className + ":hover" + " { border-color: " + value + " }";
    }
  ...
  public enum BorderTopColor implements StyleClass {
    ...
    @Override
    public final String toString() {
      return "." + className + ":hover" + " { border-top-color: " + value + " }";
    }
  ...
  public enum BorderRightColor implements StyleClass {
    ...
    @Override
    public final String toString() {
      return "." + className + ":hover" + " { border-right-color: " + value + " }";
    }
  ...
  public enum BorderBottomColor implements StyleClass {
    ...
    @Override
    public final String toString() {
      return "." + className + ":hover" + " { border-bottom-color: " + value + " }";
    }
  ...
  public enum BorderLeftColor implements StyleClass {
    ...
    @Override
    public final String toString() {
      return "." + className + ":hover" + " { border-left-color: " + value + " }";
    }
  ...
  public enum BorderXColor implements StyleClass {
    ...
    @Override
    public final String toString() {
      return "." + className + ":hover" + " { border-right-color: " + value + "; border-left-color: " + value + " }";
    }
  ...
  public enum BorderYColor implements StyleClass {
    ...
    @Override
    public final String toString() {
      return "." + className + ":hover" + " { border-top-color: " + value + "; border-bottom-color: " + value + " }";
    }
  ...
  public enum TextColor implements StyleClass {
    ...
    @Override
    public final String toString() {
      return "." + className + ":hover" + " { color: " + value + " }";
    }
