 ...
 */
public class UnmodifiableMap<K, V> extends AbstractArrayBasedMap<K, V> {

  private static final UnmodifiableMap<Object, Object> EMPTY
      = new UnmodifiableMap<Object, Object>();

  UnmodifiableMap(Object[] array, int size) {
    this.array = array;
