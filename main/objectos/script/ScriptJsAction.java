...
final class ScriptJsAction implements JsAction {

  private static final JsString CW = ScriptJsString.raw("CW");
  ...
  static ScriptJsAction of(JsAction first, JsAction second, JsAction[] more) {
  ...
  public static ScriptJsAction of(JsObject v0) {
    return new ScriptJsAction(
        "[" + v0.toString() + "]"
    );
  }

  public static ScriptJsAction of(JsObject v0, JsObject v1) {
    return new ScriptJsAction(
        "[" + v0.toString() + "," + v1.toString() + "]"
    );
  }

  static ScriptJsAction var(String name, JsObject value) {
