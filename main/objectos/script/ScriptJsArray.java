...
final class ScriptJsArray extends ScriptJsObject implements JsArray {
  ...
  private static final JsString Array = ScriptJsString.raw("Array");
  ...
  public static ScriptJsArray rawArgs(JsObject[] args) {
  ...
  private static final JsString FE = ScriptJsString.raw("FE");
