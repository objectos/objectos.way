...
public sealed interface HeaderValueOptions permits HeaderValueBuilder {
  ...
  /// Appends a parameter to the current header value with the specified name
  /// and value.
  ///
  /// @param name the parameter name
  /// @param value the parameter value
  ///
  /// @throws IllegalArgumentException if either the name or the value contains
  ///         invalid characters
