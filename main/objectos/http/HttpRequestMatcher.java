...
final class HttpRequestMatcher implements Predicate<HttpRequest> {
  ...
  static HttpRequestMatcher methodAllowed(HttpMethod value) {
    return new HttpRequestMatcher(Kind.METHOD_ALLOWED, value);
  }

  static HttpRequestMatcher methodNotAllowed(Set<HttpMethod> allowedMethods) {
