...
final class HttpStaticFiles0 implements HttpStaticFiles {

  private final Note.Ref1<Path> created = Note.Ref1.create(HttpStaticFiles.class, "ADD", Note.DEBUG);

  private final Note.Ref2<String, String> contentTypeRegistered = Note.Ref2.create(HttpStaticFiles.class, "CTR", Note.DEBUG);

  private final Note.Ref3<String, String, String> contentTypeIgnored = Note.Ref3.create(HttpStaticFiles.class, "CTI", Note.DEBUG);
  ...
  HttpStaticFiles0(Note.Sink noteSink, Path rootDirectory) {
  ...
  @Override
  public final void addFile(String pathName, InputStream in) throws IOException {
    final Path path;
  ...
  @Override
  public final void addMedia(String pathName, Media media) throws IOException {
    final Path path;
    path = toPath(pathName);
