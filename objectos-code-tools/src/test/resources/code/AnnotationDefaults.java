...
public @interface AnnotationDefaults {
  ...
  String defaultString() default "I'm default";
  
  Level defaultEnum() default Level.LEVEL_2;
  
  Class<?> defaultClass() default Integer.class;

  TypeAnnotation defaultAnnotation() default @TypeAnnotation(string = "xpto");
  
  int defaultInt() default 123;
  
  long[] defaultLongArray() default { 3l, 5l };
