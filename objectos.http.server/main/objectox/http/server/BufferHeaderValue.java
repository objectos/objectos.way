...
public record BufferHeaderValue(byte[] buffer, int start, int end) implements HeaderValue {

  public static final BufferHeaderValue EMPTY = new BufferHeaderValue(ByteArrays.empty(), 0, 0);
  ...
  public final boolean equals(Object obj) {
    return obj == this ||
        obj instanceof BufferHeaderValue that
