...
public class Mysql57Test extends AbstractMysqlTest {
  ...
  public void _beforeClassInit() throws IOException {
    directoryBase = LocalFs.getDirectory(
        System.getProperty("objectos.mysql57.baseDir")
    );

    directoryBinariesClient = LocalFs.getDirectory(
        System.getProperty("objectos.mysql57.binaryDirClient")
    );

    directoryBinariesServer = LocalFs.getDirectory(
        System.getProperty("objectos.mysql57.binaryDirServer")
    );

    release = Release.MYSQL_5_7;
  }
  ...
  @Test(enabled = false, dependsOnMethods = "testCase07")
  public void testCase08() throws Exception {
    testCase08Impl();
  }

  @Test(enabled = false, dependsOnMethods = "testCase08")
