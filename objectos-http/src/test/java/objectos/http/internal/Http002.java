...
public final class Http002 implements Handler {
  ...
  private static final String PAYLOAD_600_BYTES = """
    
  ...
  public final void handle(Exchange exchange) {
    ...
    response.header(Http.Header.CONTENT_LENGTH, Long.toString(600));

    response.header(Http.Header.DATE, Http.formatDate(DATE));

    response.send(Bytes.utf8(PAYLOAD_600_BYTES));
  }
