...
/**
 * Support reading and parsing loose objects (iter. 2).
 *
 * 0) Materialize use-case
 * 1) bare repo
 * 2) loose objects only
 * 3) commit with single parent (no merge)
 * 4) /README.md, /bin/ci (executable)
 *
 * @since 1
 */
final class TestCase01 {

  public static final String DESCRIPTION = "Support loose objects (iter 2)";
