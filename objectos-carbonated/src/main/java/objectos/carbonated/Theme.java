...
public final class Theme {
  ...
  public static final ClassSelector WHITE = U.cs("white");

  public static final ClassSelector G100 = U.cs("g100");

  public static final ClassSelector G90 = U.cs("g90");

  public static final ClassSelector G10 = U.cs("g10");

  // @formatter:off

  static final CustomProperty<ColorValue> BACKGROUND = U.prop("background");
  static final CustomProperty<ColorValue> BACKGROUND_INVERSE = U.prop("background-inverse");

  static final CustomProperty<ColorValue> BUTTON_PRIMARY = U.prop("button-primary");
  static final CustomProperty<ColorValue> BUTTON_PRIMARY_ACTIVE = U.prop("button-primary-active");
  static final CustomProperty<ColorValue> BUTTON_PRIMARY_HOVER = U.prop("button-primary-hover");

  static final CustomProperty<ColorValue> FOCUS = U.prop("focus");

  static final CustomProperty<ColorValue> LINK_PRIMARY = U.prop("link-primary");
  static final CustomProperty<ColorValue> LINK_INVERSE = U.prop("link-inverse");

  static final CustomProperty<ColorValue> NOTIFICATION_BACKGROUND_ERROR = U.prop("notification-background-error");
  static final CustomProperty<ColorValue> NOTIFICATION_BACKGROUND_SUCCESS = U.prop("notification-background-success");
  static final CustomProperty<ColorValue> NOTIFICATION_BACKGROUND_INFO = U.prop("notification-background-info");
  static final CustomProperty<ColorValue> NOTIFICATION_BACKGROUND_WARNING = U.prop("notification-background-warning");

  static final CustomProperty<ColorValue> SUPPORT_ERROR = U.prop("support-error");
  static final CustomProperty<ColorValue> SUPPORT_SUCCESS = U.prop("support-success");
  static final CustomProperty<ColorValue> SUPPORT_WARNING = U.prop("support-warning");
  static final CustomProperty<ColorValue> SUPPORT_INFO = U.prop("support-info");
  static final CustomProperty<ColorValue> SUPPORT_ERROR_INVERSE = U.prop("support-error-inverse");
  static final CustomProperty<ColorValue> SUPPORT_SUCCESS_INVERSE = U.prop("support-success-inverse");
  static final CustomProperty<ColorValue> SUPPORT_WARNING_INVERSE = U.prop("support-warning-inverse");
  static final CustomProperty<ColorValue> SUPPORT_INFO_INVERSE = U.prop("support-info-inverse");

  static final CustomProperty<ColorValue> TEXT_PRIMARY = U.prop("text-primary");
  static final CustomProperty<ColorValue> TEXT_INVERSE = U.prop("text-inverse");
  static final CustomProperty<ColorValue> TEXT_ON_COLOR = U.prop("text-on-color");
  static final CustomProperty<ColorValue> TEXT_ON_COLOR_DISABLED = U.prop("text-on-color-disabled");

  // @formatter:on

  private Theme() {}

  static class White extends CssTemplate {
    @Override
