...
public final class Impl implements Carbon {
  ...
  Impl(ImplBuilder b) {
    THEME_WHITE = b.next.classSelector();

    GRID = b.next.classSelector();
    GRID_STD = b.next.classSelector();
    GRID_FULL = b.next.classSelector();
    GRID_NARROW = b.next.classSelector();
    GRID_CONDENSED = b.next.classSelector();
  }

  @Override
  public final Grid grid() {
    return new CompGrid(this);
  }

  @Override
  public final GridColumn gridColumn() {
