...
abstract class SelfgenRuleSetBuilder<SELF extends SelfgenRuleSetBuilder<SELF>> extends AbstractRuleSetBuilder<SELF> {
  ...
  public SELF position(StaticKeyword value) {
    return addDeclaration("position", value);
  }

  public SELF position(RelativeKeyword value) {
    return addDeclaration("position", value);
  }

  public SELF position(AbsoluteKeyword value) {
    return addDeclaration("position", value);
  }

  public SELF position(FixedKeyword value) {
    return addDeclaration("position", value);
  }

  public SELF position(InheritKeyword value) {
    return addDeclaration("position", value);
  }
}
