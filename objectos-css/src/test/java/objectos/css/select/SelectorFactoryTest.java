...
import static objectos.css.Css.a;
import static objectos.css.Css.b;
import static objectos.css.Css.body;
import static objectos.css.Css.input;
import static objectos.css.Css.p;
import static objectos.css.Css.strong;
import static objectos.css.select.Combinator.CHILD;
import static objectos.css.select.SelectorFactory.any;
import static objectos.css.select.SelectorFactory.attr;
import static objectos.css.select.SelectorFactory.cn;
...
import static objectos.css.select.SelectorFactory.id;
import static objectos.css.select.SelectorFactory.lang;
import static objectos.css.select.SelectorFactory.or;
import static objectos.css.select.SelectorFactory.sel;
import static objectos.css.select.SelectorFactory.sp;
