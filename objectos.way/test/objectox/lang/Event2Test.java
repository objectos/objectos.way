...
public class Event2Test {
  ...
  @Test
  public void source() {
    assertEquals(TRACE.source(), "objectox.lang.Event2Test");
    assertEquals(DEBUG.source(), "objectox.lang.Event2Test");
    assertEquals(INFO.source(), "objectox.lang.Event2Test");
    assertEquals(WARN.source(), "objectox.lang.Event2Test");
    assertEquals(ERROR.source(), "objectox.lang.Event2Test");
  }
