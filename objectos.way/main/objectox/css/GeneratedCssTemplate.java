...
import objectos.css.tmpl.Api.AlignItemsValue;
...
import objectos.css.tmpl.Api.BaselineKeyword;
import objectos.css.tmpl.Api.BaselinePosition;
...
import objectos.css.tmpl.Api.StretchKeyword;
...
abstract class GeneratedCssTemplate {
  ...
  protected static final BaselineKeyword baseline = StandardName.baseline;
  ...
  protected static final BaselinePosition last = StandardName.last;
  ...
  protected static final SelfPosition selfEnd = StandardName.selfEnd;

  protected static final SelfPosition selfStart = StandardName.selfStart;
  ...
  protected static final StretchKeyword stretch = StandardName.stretch;
  ...
  protected final StyleDeclaration alignItems(GlobalKeyword value) {
    Check.notNull(value, "value == null");
    declaration(Property.ALIGN_ITEMS, value);
    return InternalInstruction.INSTANCE;
  }

  protected final StyleDeclaration alignItems(AlignItemsValue value) {
    Check.notNull(value, "value == null");
    declaration(Property.ALIGN_ITEMS, value);
    return InternalInstruction.INSTANCE;
  }

  protected final StyleDeclaration alignItems(BaselinePosition firstOrLast, BaselineKeyword baseline) {
    Check.notNull(firstOrLast, "firstOrLast == null");
    Check.notNull(baseline, "baseline == null");
    declaration(Property.ALIGN_ITEMS, firstOrLast, baseline);
    return InternalInstruction.INSTANCE;
  }

  protected final StyleDeclaration alignItems(OverflowPosition safeOrUnsafe, SelfPosition position) {
    Check.notNull(safeOrUnsafe, "safeOrUnsafe == null");
    Check.notNull(position, "position == null");
    declaration(Property.ALIGN_ITEMS, safeOrUnsafe, position);
    return InternalInstruction.INSTANCE;
  }
